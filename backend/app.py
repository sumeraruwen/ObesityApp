...
# from datetime import datetime
# import random
# import joblib  # Added for exercise model loading
...
#     'Seated Cat-Cow Stretch - 7 min': 'Stretching',
...
#     'Arm Curls (Light Weights) - 8 min': 'Strength',
...
#     try:
#         data = request.get_json()
#         print("Received exercise input:", data)
#         suitable_exercises = []
...
#                 'Activity_Level': le_activity.transform([data['Activity_Level']])[0],
#                 'Health_Condition': le_health.transform([data['Health_Condition']])[0],
...
# # Meal categories with expanded options for Breakfast, Lunch, and Dinner
# meal_categories = {
#     'High-Protein Meal': {
#         'Breakfast': [
#             ('Protein oatmeal with berries', 350, 450),
#             ('Egg scramble with turkey bacon', 400, 500),
#             ('Greek yogurt with whey protein', 370, 470),      
#             ('Chicken sausage with eggs', 390, 490)            
#         ],
#         'Lunch': [
#             ('Grilled chicken breast with quinoa', 500, 600),
#             ('Turkey wrap with veggies', 450, 550),
#             ('Beef stir-fry with brown rice', 480, 580),       
#             ('Chicken salad with almonds', 460, 560)          
#         ],
#         'Dinner': [
#             ('Pan-seared steak with sweet potato', 600, 700),
#             ('Baked turkey with brown rice', 550, 650),
#             ('Grilled pork chop with veggies', 580, 680),      
#             ('Chicken thigh with roasted potatoes', 570, 670) 
#         ]
#     },
#     'Omega-3 Rich Meal': {
#         'Breakfast': [
#             ('Salmon avocado toast', 400, 500),
#             ('Chia seed pudding with fish oil', 350, 450),
#             ('Smoked mackerel on rye bread', 380, 480),        
#             ('Sardine omelette', 360, 460)                 
#         ],
#         'Lunch': [
#             ('Grilled salmon with quinoa', 500, 600),
#             ('Tuna salad with leafy greens', 450, 550),
#             ('Mackerel patties with veggies', 470, 570),      
#             ('Sardine wrap with spinach', 460, 560)           
#         ],
#         'Dinner': [
#             ('Baked salmon with roasted veggies', 600, 700),
#             ('Poached fish with cauliflower rice', 550, 650),
#             ('Grilled trout with asparagus', 580, 680),       
#             ('Tuna steak with zucchini noodles', 570, 670)   
#         ]
#     },
#     'Vegetarian Meal': {
#         'Breakfast': [
#             ('Greek yogurt with nuts and fruit', 300, 400),
#             ('Tofu scramble with spinach', 350, 450),
#             ('Overnight oats with chia seeds', 320, 420),    
#             ('Avocado toast with hemp seeds', 340, 440)       
#         ],
#         'Lunch': [
#             ('Lentil curry with brown rice', 450, 550),
#             ('Black bean burger with greens', 400, 500),
#             ('Chickpea salad with avocado', 430, 530),         
#             ('Veggie stir-fry with tofu', 420, 520)           
#         ],
#         'Dinner': [
#             ('Chickpea curry with veggies', 500, 600),
#             ('Quinoa stuffed peppers', 450, 550),
#             ('Lentil stew with sweet potato', 470, 570),       
#             ('Tofu stir-fry with broccoli', 460, 560)         
#         ]
#     },
#     'Low-Carb Meal': {
#         'Breakfast': [
#             ('Avocado egg cups', 300, 400),
#             ('Keto sausage muffins', 350, 450),
#             ('Bacon and spinach frittata', 320, 420),          
#             ('Almond flour pancakes', 340, 440)                
#         ],
#         'Lunch': [
#             ('Turkey meatballs with spinach', 420, 520),  
#             ('Grilled chicken with avocado', 450, 550),
#             ('Steak salad with olive oil', 400, 500),
#             ('Pork tenderloin with zucchini', 430, 530),       
           
#         ],
#         'Dinner': [
#             ('Pan-seared steak with cauliflower mash', 500, 600),
#             ('Salmon with asparagus', 550, 650),
#             ('Chicken thighs with Brussels sprouts', 520, 620),
#             ('Pork chop with kale', 540, 640)                  
#         ]
#     },
#     'Mediterranean Meal': {
#         'Breakfast': [
#             ('Greek yogurt with honey', 300, 400),
#             ('Feta omelette with olives', 350, 450),
#             ('Tomato and basil scramble', 320, 420),           
#             ('Hummus toast with cucumber', 340, 440)         
#         ],
#         'Lunch': [
#             ('Chicken quinoa salad', 450, 550),
#             ('Hummus veggie wrap', 400, 500),
#             ('Falafel bowl with tahini', 430, 530),          
#             ('Grilled fish with tabbouleh', 460, 560)          
#         ],
#         'Dinner': [
#             ('Baked salmon with couscous', 550, 650),
#             ('Fish with roasted veggies', 500, 600),
#             ('Lamb kebabs with tzatziki', 570, 670),           
#             ('Shrimp with Mediterranean rice', 540, 640)      
#         ]
#     }
# }
...
# # Exercise categories (matches v3 dataset with 70 exercises)
# exercise_categories = {
#     'Full Body Stretch - 5 min': 'Stretching', 'Seated Hamstring Stretch - 10 min': 'Stretching',
#     'Shoulder and Arm Stretch - 8 min': 'Stretching', 'Neck and Back Stretch - 6 min': 'Stretching',
...
# # # Exercise categories with expanded options
# # exercise_categories = {
# #     'Full Body Stretch - 5 min': 'Stretching',
# #     'Seated Hamstring Stretch - 10 min': 'Stretching',
# #     'Shoulder and Arm Stretch - 8 min': 'Stretching',
# #     'Neck and Back Stretch - 6 min': 'Stretching',
# #     'Seated Cat-Cow Stretch - 7 min': 'Stretching',
# #     'Hip Flexor Stretch - 8 min': 'Stretching',
# #     'Standing Quad Stretch - 6 min': 'Stretching',
# #     'Gentle Yoga Flow - 10 min': 'Stretching',
    
# #     'Brisk Walking - 20 min': 'Cardio',
# #     'Water Aerobics - 15 min': 'Cardio',
# #     'Stationary Cycling - 15 min': 'Cardio',
# #     'Slow Pace Walking - 25 min': 'Cardio',
# #     'Step-Ups (Low Height) - 12 min': 'Cardio',
# #     'Chair Cardio Dance - 10 min': 'Cardio',
# #     'Low-Impact Jumping Jacks - 12 min': 'Cardio',
# #     'Seated Bike Pedaling - 15 min': 'Cardio',
# #     'Marching in Place - 20 min': 'Cardio',
    
# #     'Chair Squats - 10 min': 'Strength',
# #     'Wall Push-Ups - 8 min': 'Strength',
# #     'Seated Resistance Band Rows - 10 min': 'Strength',
# #     'Leg Press (Seated) - 12 min': 'Strength',
# #     'Arm Curls (Light Weights) - 8 min': 'Strength',
# #     'Standing Heel Raises - 8 min': 'Strength',
# #     'Seated Shoulder Press - 10 min': 'Strength',
# #     'Knee Extensions with Band - 12 min': 'Strength',
    
# #     'Seated Marching - 15 min': 'Mobility',
# #     'Arm Circles - 5 min': 'Mobility',
# #     'Side Leg Lifts - 10 min': 'Mobility',
# #     'Ankle Rotations - 6 min': 'Mobility',
# #     'Wrist and Finger Flex - 5 min': 'Mobility',
# #     'Seated Torso Twists - 8 min': 'Mobility',
# #     'Hip Circles - 7 min': 'Mobility'
# # }
